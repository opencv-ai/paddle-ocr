...
model, check = onnxsim.simplify('./source/en_number_mobile_v2.0_rec_infer_fixed_shape.onnx', input_shapes={'x': [1, 3, 32, 832]})
assert check, "couldn't valide"
onnx.save(model, './source/en_number_mobile_v2.0_rec_infer_fixed_shape_simplified.onnx')


model = onnx.load('./source/en_number_mobile_v2.0_rec_infer_fixed_shape_simplified.onnx')
...
model = shape_inference.infer_shapes(model)
onnx.save(model, './changed/recognition_v1_1.onnx')
print('ok')